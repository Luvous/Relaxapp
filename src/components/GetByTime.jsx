    ...
    if (hour > 7 && hour <= 11) {
        return (
            <div className='container'>
                {/* <h1>Morning</h1> */}
                <img className='time_background' src={image_earlymorning} />
            </div>
        )
        ...
        return (
            <div className='container'>
                {/* <h1>Mid Day</h1> */}
                <img className='time_background' src={image_midday} />
            </div>
        )
        ...
        return (
            <div className='container'>
                {/* <h1>Evening</h1> */}
                <img className='time_background' src={image_evening} />
            </div>
        )
        ...
        return (
            <div className='container'>
                {/* <h1>Night</h1> */}
                <img className='time_background' src={image_night} />
            </div>
